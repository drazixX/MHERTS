...
if (!empty($_SESSION['id'])) {
    ...
    if ($result && !empty($result['avatar'])) {
        ...
        $avatarSrc = 'assets/ada logo.png'; // Change this path accordingly
    }
} else {
    // Use a default avatar if the user is not logged in
    $avatarSrc = 'assets/default_avatar.png'; // Change this path accordingly
}
...
<ul class="navbar-nav header-right">
	...
	<li class="nav-item dropdown header-profile">
		...
		<div class="dropdown-menu dropdown-menu-end">
			...
			<a href="page_login.php" class="dropdown-item ai-icon">
