...
document.addEventListener('DOMContentLoaded', function() {
    fetch('fetch_edd_data.php')
    .then(response => response.json())
    .then(data => {
        const ctx = document.getElementById('eddChart').getContext('2d');
        new Chart(ctx, {
            type: 'bar',
            data: {
...
.card-body {
    ...
    width: 100%;
    height: 100%;
    padding: 0; /* Remove padding to ensure full space usage */
}
...
canvas {
    ...
    display: block;
			...
			<!-- Top Rated Doctors & Staff -->

			<div class="col-xl-9 col-xxl-8 col-lg-7">
				<div class="card">	
					<div class="card-header border-0 pb-0">
						<h3 class="fs-20 mb-0 text-black">Clinic Midwives</h3>
						<!-- <a href="reviews.php" class="text-primary font-w500">View more >></a> -->
					</div>
					<div class="card-body">
						<div class="assigned-doctor owl-carousel">

						<?php
							include './top_doctors.php';
							?>
