!function(e) {
    var t, a, n, l, i, s, o, c, r, d, u, h, f, m, v, p, g, b, k, C, z, y, $, w, x, F = (t = e(window).width(),
    a = function() {
    ...
    n = function() {
        ...
        e(".nav-control").on("click", function() {
            ...
            "full" === t.attr("data-sidebar-style") && "vertical" === t.attr("data-layout") && (e("#main-wrapper").hasClass("menu-toggle") ? t.attr("data-sidebar-position", "static") : t.attr("data-sidebar-position", "fixed"))
        })
    }
    ,
    l = function() {
    ...
    s = function() {
        e("ul#menu>li").on("click", function() {
            ...
            "mini" === t && (console.log(e(this).find("ul")),
            e(this).find("ul").stop())
        })
    }
    ,
    o = function() {
        e('a[data-action="collapse"]').on("click", function(t) {
            t.preventDefault(),
            e(this).closest(".card").find('[data-action="collapse"] i').toggleClass("mdi-arrow-down mdi-arrow-up"),
            e(this).closest(".card").children(".card-body").collapse("toggle")
        }),
        e('a[data-action="expand"]').on("click", function(t) {
            t.preventDefault(),
            e(this).closest(".card").find('[data-action="expand"] i').toggleClass("icon-size-actual icon-size-fullscreen"),
    ...
    c = function() {
        ...
        e('[data-action="reload"]').on("click", function() {
            ...
            t.parents(".card").append('<div class="card-loader"><i class=" ti-reload rotate-refresh"></div>'),
            setTimeout(function() {
    ...
    ,
    g = function() {
        jQuery("#smartwizard").length > 0 && e("#smartwizard").smartWizard()
    }
    ,
    b = function() {
    ...
    y = function() {
        if (jQuery(".dz-theme-mode").length > 0) {
            jQuery(".dz-theme-mode").on("click", function() {
                jQuery(this).toggleClass("active"),
                jQuery(this).hasClass("active") ? (jQuery("body").attr("data-theme-version", "dark"),
                setCookie("version", "dark"),
                jQuery("#theme_version").val("dark")) : (jQuery("body").attr("data-theme-version", "light"),
