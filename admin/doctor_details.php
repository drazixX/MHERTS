...
<html lang="en">
	...
	<link rel="shortcut icon" type="image/x-icon" sizes="16x16" href="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/favicon.png">	
		 ...
		 <link href="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/chartist/css/chartist.min.css" rel="stylesheet" type="text/css"/>	
...
<div class="content-body">
	...
	<div class="container-fluid">
		...
		<div class="d-block d-sm-flex mb-3 mb-md-4">
			<a href="javascript:void(0);" class="btn btn-outline-primary btn-rounded mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-calendar-plus me-2 scale5 me-2"></i>+ New Appointment</a>
			<select class="default-select ms-auto me-1 image-select style-2">
				<option data-thumbnail="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/svg/check-circle%201.svg" data-content="<img src='images/svg/check-circle 1.svg'/>">Available</option>
				<option data-thumbnail="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/svg/check-circle%201.svg" data-content="<img src='images/svg/check-circle 1.svg'/>">Daily</option>
				<option data-thumbnail="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/svg/check-circle%201.svg" data-content="<img src='images/svg/check-circle 1.svg'/>">Weekly</option>
				<option data-thumbnail="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/svg/check-circle%201.svg" data-content="<img src='images/svg/check-circle 1.svg'/>">Monthly</option>
			</select>
			<a href="javascript:void(0);" class="btn btn-primary btn-rounded mb-2 ms-2"><i class="fas fa-pencil"></i>&nbsp; Edit</a>
		</div>
		<div class="row">
						...
						<div id="DZ_W_Todo2" class="widget-media dz-scroll px-4 height370">
							<ul class="timeline">
								<li>
									<div class="timeline-panel bgl-dark flex-wrap border-0 p-3 rounded">
										<div class="media bg-transparent me-2">
											<img class="rounded-circle" alt="image" width="48" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/widget/6.jpg">
										</div>
								...
								<li>
									<div class="timeline-panel bgl-dark flex-wrap border-0 p-3 rounded">
										<div class="media bg-transparent me-2">
											<img class="rounded-circle" alt="image" width="48" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/widget/7.jpg">
										</div>
										<div class="media-body">
											<h5 class="mb-1 fs-18">Cive Slauw</h5>
											<span>Physical Therapy</span>
								...
								<li>
									<div class="timeline-panel bgl-dark flex-wrap border-0 p-3 rounded">
										<div class="media bg-transparent me-2">
											<img class="rounded-circle" alt="image" width="48" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/widget/8.jpg">
										</div>
										<div class="media-body">
											<h5 class="mb-1 fs-18">Cive Slauw</h5>
											<span>Physical Therapy</span>
								...
								<li>
									<div class="timeline-panel bgl-dark flex-wrap border-0 p-3 rounded">
										<div class="media bg-transparent me-2">
											<img class="rounded-circle" alt="image" width="48" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/widget/5.jpg">
										</div>
										<div class="media-body">
											<h5 class="mb-1 fs-18">Cive Slauw</h5>
											<span>Physical Therapy</span>
								...
								<li>
									<div class="timeline-panel bgl-dark flex-wrap border-0 p-3 rounded">
										<div class="media bg-transparent me-2">
											<img class="rounded-circle" alt="image" width="48" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/widget/1.jpg">
										</div>
										<div class="media-body">
											<h5 class="mb-1 fs-18">Cive Slauw</h5>
											<span>Physical Therapy</span>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="map-bx mb-3">
									<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/svg/map.svg" alt="">
				...
				<div class="assigned-doctor2 owl-carousel">
					<div class="items">
						<div class="media bg-white p-4 rounded align-items-center">
							<img class="me-3" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/doctors/6.jpg" alt="">
							<div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
								<div class="me-2">
									<h4 class="fs-20"><a class="text-black" href="https://eres.dexignzone.com/codeigniter/demo/reviews">Glee Smiley</a></h4>
					...
					<div class="items">
						<div class="media bg-white p-4 rounded align-items-center">
							<img class="me-3" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/doctors/7.jpg" alt="">
							<div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
								<div class="me-2">
									<h4 class="fs-20"><a class="text-black" href="https://eres.dexignzone.com/codeigniter/demo/reviews">Stevani Anderson</a></h4>
									<p class="fs-14 mb-0"> I came with my mother, I was very nervous. But after entering here I felt warmed with smiling</p>
								</div>
								<div class="text-sm-end text-center mt-sm-0 mt-2">
					...
					<div class="items">
						<div class="media bg-white p-4 rounded align-items-center">
							<img class="me-3" src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/doctors/8.jpg" alt="">
							<div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
								<div class="me-2">
									<h4 class="fs-20"><a class="text-black" href="https://eres.dexignzone.com/codeigniter/demo/reviews">Cive Slauw</a></h4>
									<p class="fs-14 mb-0"> I came with my mother, I was very nervous. But after entering here I felt warmed with smiling</p>
								</div>
								<div class="text-sm-end text-center mt-sm-0 mt-2">
...
***********************************-->        
    ...
    <script> var base_url = 'https://eres.dexignzone.com/codeigniter/demo/';</script>
            ...
            <script src="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/chartist/js/chartist.min.js"></script>
            <script src="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>
