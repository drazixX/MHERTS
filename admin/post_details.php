...
<html lang="en">
    ...
    <head>
	<!-- Title -->
	<title>ERES - CodeIgniter Hospital Admin Dashboard Template</title>
	...
	<meta name="keywords" content="	admin dashboard, codeigniter admin template, administration, analytics, bootstrap, disease, doctor, elegant, health, hospital admin, medical dashboard, modern, responsive admin dashboard">
	<meta name="description" content="Our CodeIgniter Admin Dashboard is built with a responsive design, ensuring seamless compatibility across different devices and screen sizes. The user-friendly interface makes navigation intuitive and straightforward for administrators.">

	<meta property="og:title" content="ERES - CodeIgniter Hospital Admin Dashboard Template">
	<meta property="og:description" content="Our CodeIgniter Admin Dashboard is built with a responsive design, ensuring seamless compatibility across different devices and screen sizes. The user-friendly interface makes navigation intuitive and straightforward for administrators.">
	<meta property="og:image" content="https://eres.dexignzone.com/codeigniter/social-image.png">
	...
	<link rel="shortcut icon" type="image/x-icon" sizes="16x16" href="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/favicon.png">	
		 ...
		 <link href="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/lightgallery/dist/css/lightgallery.css" rel="stylesheet" type="text/css"/>	
		
		 <link href="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/lightgallery/dist/css/lg-thumbnail.css" rel="stylesheet" type="text/css"/>	
		
		 <link href="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/lightgallery/dist/css/lg-zoom.css" rel="stylesheet" type="text/css"/>	
...
<div class="nav-header">
    <a href="https://eres.dexignzone.com/codeigniter/demo/index" class="brand-logo">
						...
						<ul class="contacts">
							...
							<li class="active dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
					...
					<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
								<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
							</div>
						...
						<div class="d-flex justify-content-end mb-4">
							...
							<div class="img_cont_msg">
						<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
							</div>
						</div>
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
				...
				<ul class="navbar-nav header-right">
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="javascript:;" role="button" data-bs-toggle="dropdown">
							<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/12.png" width="20" alt="">
							<div class="header-info">
								<span>Hello,<strong> Roberto</strong></span>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							<a href="https://eres.dexignzone.com/codeigniter/demo/app_profile" class="dropdown-item ai-icon">
								<svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
								<span class="ms-2">Profile </span>
							</a>
							<a href="https://eres.dexignzone.com/codeigniter/demo/email_inbox" class="dropdown-item ai-icon">
								<svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
								<span class="ms-2">Inbox </span>
							</a>
							<a href="https://eres.dexignzone.com/codeigniter/demo/page_login" class="dropdown-item ai-icon">
        ...
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/index">Dashboard Light</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/index_2">Dashboard Dark</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/patient_list">Patient</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/patient_details">Patient Details</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/doctor_list">Doctor</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/doctor_details">Doctor Detail</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/reviews">Review</a></li>
                </ul>
            </li>
            <li><a href="https://eres.dexignzone.com/codeigniter/demo/appointment" class="ai-icon" aria-expanded="false">
            ...
            <li><a href="javascript:void(0);" class="ai-icon has-arrow" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/staff">Staff</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/staff_profile">Staff Profie</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/app_profile">Profile</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/post_details">Post Details</a></li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Email</a>
                        <ul aria-expanded="false">
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/email_compose">Compose</a></li>
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/email_inbox">Inbox</a></li>
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/email_read">Read</a></li>
                        </ul>
                    </li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/app_calender">Calendar</a></li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
                        <ul aria-expanded="false">
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_product_grid">Product Grid</a></li>
							<li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_product_list">Product List</a></li>
							<li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_product_details">Product Details</a></li>
							<li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_product_order">Order</a></li>
							<li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_checkout">Checkout</a></li>
							<li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_invoice">Invoice</a></li>
							<li><a href="https://eres.dexignzone.com/codeigniter/demo/ecom_customers">Customers</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/flot">Flot</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/morris">Morris</a></li> 
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/chartjs">Chartjs</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/chartist">Chartist</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/sparkline">Sparkline</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/peity">Peity</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/accordion">Accordion</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/alert">Alert</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/badge">Badge</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/button">Button</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/modal">Modal</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/button_group">Button Group</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/list_group">List Group</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/media_object">Media Object</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/card">Cards</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/carousel">Carousel</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/dropdown">Dropdown</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/popover">Popover</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/progressbar">Progressbar</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/tab">Tab</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/typography">Typography</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/pagination">Pagination</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/grid">Grid</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/select2">Select 2</a></li> 
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/nestable">Nestable</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/noui_slider">Noui Slider</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/sweetalert">Sweet Alert</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/toastr">Toastr</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/map_jqvmap">Jqv Map</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/lightgallery">Light Gallery</a></li>
                </ul>
            </li>
            <li><a href="https://eres.dexignzone.com/codeigniter/demo/widget_basic" class="ai-icon" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/form_element">Form Elements</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/form_wizard">Wizard</a></li>   
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/form_ckeditor">CKeditor</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/form_pickers">Pickers</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/form_validation_jquery">Form Validate</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/table_bootstrap">Bootstrap</a></li>
					<li><a href="https://eres.dexignzone.com/codeigniter/demo/table_datatable">Datatable</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_register">Register</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_login">Page Login</a></li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                        <ul aria-expanded="false">
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_error_400">Error 400</a></li>
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_error_403">Error 403</a></li>
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_error_404">Error 404</a></li>
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_error_500">Error 500</a></li>
                            <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_error_503">Error 503</a></li>
                        </ul>
                    </li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_lock_screen">Lock Screen</a></li>
                    <li><a href="https://eres.dexignzone.com/codeigniter/demo/page_empty">Empty Page</a></li>
                </ul>
            </li>
        </ul>
					...
					<div class="profile-head">
						...
						<div class="profile-info">
							<div class="profile-photo">
								<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/profile.png" class="img-fluid rounded-circle" alt="">
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="profile-blog">
									...
									<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/1.jpg" alt="" class="img-fluid rounded mt-4 mb-4 w-100">
									<h4><a href="https://eres.dexignzone.com/codeigniter/demo/post_details" class="text-black">Darwin Creative Agency Theme</a></h4>
							...
							<div class="card-body">
								<div class="profile-interest">
									...
									<div class="row mt-4 sp4" id="lightgallery">
										<a href="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img6.jpg"  data-src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img6.jpg" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img6.jpg" alt="" class="img-fluid rounded">
										</a>
										
										<a href="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img5.jpg"  data-src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img5.jpg" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img5.jpg" alt="" class="img-fluid rounded">
										</a>
										<a href="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img4.jpg"  data-src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img4.jpg" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img4.jpg" alt="" class="img-fluid rounded">
										</a>
										<a href="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img5.jpg" data-src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img5.jpg" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/big/img5.jpg" alt="" class="img-fluid rounded">
										</a>
							...
							<div class="card-body">
								<div class="profile-news">
									...
									<div class="media pt-3 pb-3">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/5.jpg" alt="image" class="me-3 rounded" width="75">
										<div class="media-body">
											<h5 class="m-b-5"><a href="https://eres.dexignzone.com/codeigniter/demo/post_details" class="text-black">Gene Therapy Triumph: Curing Incurable Diseases!</a></h5>
											<p class="mb-0">I shared this on my twitter wall a few months back, and I thought.</p>
										</div>
									</div>
									<div class="media pt-3 pb-3">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/6.jpg" alt="image" class="me-3 rounded" width="75">
										<div class="media-body">
											<h5 class="m-b-5"><a href="https://eres.dexignzone.com/codeigniter/demo/post_details" class="text-black">Hospital Outreach Program Boosts Community Health</a></h5>
											<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
										</div>
									</div>
									<div class="media pt-3 pb-3">
										<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/7.jpg" alt="image" class="me-3 rounded" width="75">
										<div class="media-body">
											<h5 class="m-b-5"><a href="https://eres.dexignzone.com/codeigniter/demo/post_details" class="text-black">AI Diagnosis: A Game-Changer in Patient Care</a></h5>
				...
				<div class="card">
					<div class="card-body">
						<div class="post-details">
							...
							<img src="https://eres.dexignzone.com/codeigniter/demo/public/assets/images/profile/8.jpg" alt="" class="img-fluid mb-3 w-100 rounded">
...
***********************************-->        
    ...
    <script> var base_url = 'https://eres.dexignzone.com/codeigniter/demo/';</script>
	        ...
	        <script src="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/lightgallery/dist/lightgallery.min.js"></script>
            <script src="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/lightgallery/dist/plugins/thumbnail/lg-thumbnail.min.js"></script>
            <script src="https://eres.dexignzone.com/codeigniter/demo/public/assets/vendor/lightgallery/dist/plugins/zoom/lg-zoom.min.js"></script>
