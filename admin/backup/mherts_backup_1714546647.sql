...
#
# Generated: Wednesday 1. May 2024
# Hostname: localhost
# Database: mherts
# --------------------------------------------------------
USE mherts;
...
CREATE TABLE `medicalhistory` (
  ...
  CONSTRAINT `medicalhistory_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`)
...
CREATE TABLE `obs_history` (
  ...
  PRIMARY KEY (`Obs_Id`),
  KEY `FamilyRec_Id` (`FamilyRec_Id`),
  CONSTRAINT `obs_history_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`)
...
INSERT INTO obs_history VALUES("19","22","0","0","0","1","0000-00-00","0000-00-00","0000-00-00","B+","");
...
CREATE TABLE `patient_status` (
  ...
  PRIMARY KEY (`id`),
  KEY `FamilyRec_Id` (`FamilyRec_Id`),
  CONSTRAINT `patient_status_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO patients_mother VALUES("22","2024-040022","Miss","Sherlyn Mae","Dacillo ","Mariano","0000-00-00","24","Female","Single","Brgy. San Roque Tanauan, Leyte","","College","Head Manager","","2024-04-29 05:28:48","Dra. Narissa Cumpio");
...
CREATE TABLE `pdrel` (
  ...
  CONSTRAINT `pdrel_ibfk_1` FOREIGN KEY (`PatientID`) REFERENCES `patients` (`PatientID`),
  CONSTRAINT `pdrel_ibfk_2` FOREIGN KEY (`DoctorID`) REFERENCES `doctors` (`DoctorID`)
...
CREATE TABLE `pdrels` (
  ...
  KEY `FamilyRec_Id` (`FamilyRec_Id`),
  KEY `DoctorID` (`DoctorID`),
  CONSTRAINT `pdrels_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`),
  CONSTRAINT `pdrels_ibfk_2` FOREIGN KEY (`DoctorID`) REFERENCES `doctors` (`DoctorID`)
...
INSERT INTO pdrels VALUES("9","22","3","");
...
CREATE TABLE `preg_files` (
  ...
  CONSTRAINT `preg_files_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`),
  CONSTRAINT `preg_files_ibfk_2` FOREIGN KEY (`history_id`) REFERENCES `preg_history` (`history_id`)
...
INSERT INTO preg_files VALUES("50","Module 1 - Lecture 3.pdf","pdf","161.61 KB","2024-05-01 11:03:50","./public/assets/documents/Module 1 - Lecture 3.pdf","15","3");
INSERT INTO preg_files VALUES("51","Module 1 - Lecture 4.pdf","pdf","157.76 KB","2024-05-01 11:04:09","./public/assets/documents/Module 1 - Lecture 4.pdf","15","3");
INSERT INTO preg_files VALUES("52","Module 1 - Lecture 5.pdf","pdf","938.08 KB","2024-05-01 11:20:54","./public/assets/documents/Module 1 - Lecture 5.pdf","15","3");
INSERT INTO preg_files VALUES("53","CYBERSECURITY REPORT.pdf","pdf","2.68 MB","2024-05-01 11:23:46","./public/assets/documents/CYBERSECURITY REPORT.pdf","15","3");
INSERT INTO preg_files VALUES("54","enterprise_architecture_for_integration_rapid_delivery_methods_and_technologiesenterprise_architecture_for_integration_rapid_delivery_methods_and_technologies.pdf","pdf","29.22 MB","2024-05-01 11:26:26","./public/assets/documents/enterprise_architecture_for_integration_rapid_delivery_methods_and_technologiesenterprise_architecture_for_integration_rapid_delivery_methods_and_technologies.pdf","15","3");
INSERT INTO preg_files VALUES("57","Free-Education-Form-for-2021-35593-SEM-2-SY-2023-2024.pdf","pdf","588.23 KB","2024-05-01 12:29:15","./public/assets/documents/Free-Education-Form-for-2021-35593-SEM-2-SY-2023-2024.pdf","15","3");
INSERT INTO preg_files VALUES("58","Free Education Form for 2020-35101 SEM 2 SY 2023-2024.pdf","pdf","555.92 KB","2024-05-01 12:31:58","./public/assets/documents/Free Education Form for 2020-35101 SEM 2 SY 2023-2024.pdf","15","3");
INSERT INTO preg_files VALUES("59","Only @ Friends Sinces 1972 Cafe.pdf","pdf","1,003.36 KB","2024-05-01 12:38:00","./public/assets/documents/Only @ Friends Sinces 1972 Cafe.pdf","15","3");
...
CREATE TABLE `preg_history` (
  ...
  KEY `FamilyRec_Id` (`FamilyRec_Id`),
  CONSTRAINT `preg_history_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`)
...
CREATE TABLE `spouseinformation` (
  ...
  KEY `FamilyRec_Id` (`FamilyRec_Id`),
  CONSTRAINT `spouseinformation_ibfk_1` FOREIGN KEY (`FamilyRec_Id`) REFERENCES `patients_mother` (`FamilyRec_Id`)
...
INSERT INTO spouseinformation VALUES("20","22","","0","","");
