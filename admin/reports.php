                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">Appointment</div>
                        </div>
...
<div class="content-body">
	...
	<?php if(isset($_SESSION['message'])): ?>
		...
		<div class="form-head d-flex mb-3 mb-md-4 align-items-start">
			<div class="me-auto d-none d-lg-block">
				<h3 class="text-black font-w600">Welcome to Admin!</h3>
				<p class="mb-0 fs-18">Cumpio Midwife Clinic</p>

			</div>
			
			<a href="#" class="btn btn-default btn-warning light shadow-sm time">
				<span class="ml-2">Philippine Standard Time: <span id="philippineTime"></span></span>
			</a>
		...
		<div class="row">	
			...
			$query = "SELECT COUNT(*) AS total_patients FROM patients_mother";
			...
			<!-- HTML code with PHP to display the total patients -->
						...
						<div class="media align-items-center">
							<div class="media-body">
								...
								<div class="d-flex flex-wrap">
									<!-- Display the total patients count retrieved from the database -->
									<h2 class="fs-40 font-w600 text-white mb-0 me-3"><?php echo $total_patients; ?></h2>
			...
			if ($result) {
				...
				// If query fails, set default count to 0
				$total_doctors = 0;
			}
			...
			<!-- HTML code with PHP to display the total doctors -->
			<div class="col-xl-3 col-xxl-3 col-sm-6">
					...
					<div class="card-body">
						<div class="media align-items-center">
							<div class="media-body">
								...
								<div class="d-flex flex-wrap">
									<h2 class="fs-40 font-w600 text-white mb-0 me-3"><?php echo $total_doctors; ?></h2>
								</div>
							</div>
							<span class="border rounded-circle p-4">
			...
			// Query to count total appointment
			$query = "SELECT COUNT(*) AS total_app FROM appointments WHERE Accepted = 2";
			$result = mysqli_query($conn, $query);
					...
					<div class="card-body">
						<div class="media align-items-center">
							<div class="media-body">
								...
								<div class="d-flex flex-wrap">
									<h2 class="fs-40 font-w600 text-white mb-0 me-3"><?php echo $total_app; ?></h2>
            ...
            <div class="media align-items-center">
                <div class="media-body">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        // Fetch the count of records from the prenatal table
                        $sql = "SELECT COUNT(*) as total FROM prenatal";
                        ...
                        <h2 class="fs-40 font-w600 text-white mb-0 me-3"><?php echo number_format($count); ?></h2>
                        <div>    
                ...
                <span class="border rounded-circle p-4">
                    <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2C9.243 2 7 4.243 7 7C7 8.659 7.794 10.129 9 10.938V13H7C6.447 13 6 13.447 6 14V16H7.293C7.938 16 8.523 16.402 8.789 17L11 22H13L15.211 17C15.477 16.402 16.062 16 16.707 16H18V14C18 13.447 17.553 13 17 13H15V10.938C16.206 10.129 17 8.659 17 7C17 4.243 14.757 2 12 2ZM12 4C13.654 4 15 5.346 15 7C15 8.654 13.654 10 12 10C10.346 10 9 8.654 9 7C9 5.346 10.346 4 12 4Z" fill="white"/>
                    </svg>
                </span>
            </div>
        </div>
			...
			<div class="col-xl-3 col-xxl-4 col-lg-4">
				<div class="card">
					<div class="card-header border-0 pb-0">
						<h3 class="fs-20 mb-0 text-black">Gave birth at the clinic</h3>
					...
					<div class="card-body px-2 pt-3 pb-2">
						<div class="px-4">
							<span class="text-info fs-24 font-w600 me-3">10k</span>
							<span class="text-secondary fs-18 font-w400">5k</span>
						</div>
        ...
        <div class="card-header d-sm-flex d-block border-0 pb-0">
            ...
            <div class="card-action card-tabs mt-3 mt-sm-0">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#quarterly" role="tab">
                            Quarterly
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- <script> var base_url = 'https://eres.dexignzone.com/codeigniter/demo/';</script> -->
            ...
            <script src="public/assets/js/dashboard/patients_stat.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeChart(chartId, dataEndpoint, labels) {
        fetch(dataEndpoint)
    ...
    initializeChart('eddChart', 'fetch_edd_data.php', ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']);
    initializeChart('weeklyChart', 'fetch_weekly_data.php', ['Week 1', 'Week 2', 'Week 3', 'Week 4']);
    initializeChart('todayChart', 'fetch_today_data.php', ['Morning', 'Afternoon', 'Evening']);
    initializeChart('quarterlyChart', 'fetch_quarterly_data.php', ['Q1', 'Q2', 'Q3', 'Q4']);
    initializeChart('yearlyChart', 'fetch_yearly_data.php', ['2021', '2022', '2023', '2024']);
    initializeChart('customChart', 'fetch_custom_data.php', ['Custom1', 'Custom2', 'Custom3']);
});
